...
# Режимы торговли.
# "revers" и "both" — алиасы: оба включают long+short с разворотом позиции.
# Движок (core/backtest.py) принимает все четыре строки.
TRADE_MODES: Final[tuple] = ("both", "revers", "long", "short")
