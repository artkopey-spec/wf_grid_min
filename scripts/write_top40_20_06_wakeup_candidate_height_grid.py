"""Write a top-40% follow-up tester grid from the 20.06 batch results."""
...
DEFAULT_SUMMARY = Path(
    r"C:\Users\lizko\OneDrive\Рабочий стол\массовые прогоны\20.06"
    r"\tester_summary_20260617_122744.xlsx"
)
DEFAULT_OUT_DIR = ROOT / "config tester 20.06 top40 candidate_height"
TOP_FRACTION = Decimal("0.40")
...
PARAM_RE = re.compile(
    r"(?P<source_idx>\d+)_modeD(?:_[a-z]+)?_lite_(?P<trade_mode>[a-z]+)_"
...
def _render_config(
    *,
    ...
    return f"""# Auto-generated top-40% 20.06 candidate-height branch config #{output_idx}
