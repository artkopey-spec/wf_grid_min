    ...
    for pr in period_results:
        ...
        if is_wakeup_mode:
            row.update({
                ...
                "Wakeup Exit Local Median Stop": s.get("wakeup_exit_local_median_stop_count", ctr.get("wakeup_exit_local_median_stop_count", 0)),
                "Wakeup Exit Cycle Take Profit": s.get("wakeup_exit_cycle_take_profit_count", ctr.get("wakeup_exit_cycle_take_profit_count", 0)),
